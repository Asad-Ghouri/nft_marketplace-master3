...
// export default function RreSale() {
...
//         alt=""
//       />
//       <h3 className="user-frs swap-frs">Raffle</h3>
...
//       <div className="preSaleinRaffel">
//         <iframe
//           id="iframe_R"
//           className="raffelIframe"
//           src="https://site.omanautocare.com/"
//           height="940px"
//           width="100%"
//         ></iframe>
//       </div>
...
const Raffle: NextPage = () => {
    ...
    const [ReserveValue, setReserveValue] = useState<any>("5");
    ...
    async function listitem(id: string) {
        ...
        if (gp || !gp) {
            ...
            const auction = {
                ...
                listingDurationInSeconds: 17280,
                ...
                reservePricePerToken: ReserveValue,
            }



            const tx = await marketcontract.auction.createListing(auction);
            ...
            await marketcontract.auction.makeBid(listingId, pricePerToken);
    ...
    return (
        <>
            ...
            <img
                ...
                alt=""
            />
            <h3 className="user-frs swap-frs">CREATE RAFFLE</h3>
            <Link href="/Marketplace">
            ...
            <div className={address ? styles.container : styles.container + " " + styles.ccbtn}>
                ...
                <h1 className={!isLoading ? styles.yb : styles.dn}>Raffle YOUR NFTS!</h1>
                ...
                {!address ? (
                    ...
                    <>
                        ...
                        {!isLoading ?
                                        ...
                                        {ownedNFTs?.map((nft) => (
                                            ...
                                            >
                                                ...
                                                <form>
                                                    ...
                                                    }} className={styles.listingInput} placeholder="Enter Reserve price" />
                                                </form>
                                                <button
                            ...
                            :
                            <div className={styles.loadingss}>
                                <Spinner
                                    thickness="4px"
                                    speed="0.65s"
                                    emptyColor="gray.200"
